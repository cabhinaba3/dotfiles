...
PKGS_DESKTOP="alacritty picom i3-wm i3status i3lock dunst feh xsetroot xrandr j4-dmenu-desktop pamixer brightnessctl network-manager-applet blueman ttf-jetbrains-mono-nerd"
